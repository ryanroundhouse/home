  ...
  return new Promise((resolve) => {
    ...
    right.innerHTML = `
      ...
      <div class="meminject-right-status">
        <div class="meminject-timer" aria-label="Time remaining"><span class="meminject-timer-value"></span>s</div>
    ...
    const timerValueEl = right.querySelector('.meminject-timer-value');
